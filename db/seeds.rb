...
t2 = Tiger.create(name: "Rowdy", price: 200, breed: "Siberian", health: 20, time_born: nil, alive?: true, bought?: false)
t3 = Tiger.create(name: "Chunky", price: 350, breed: "Siberian", health: 20, time_born: nil, alive?: true, bought?: false)
t4 = Tiger.create(name: "Darlene", price: 250, breed: "Asian", health: 20, time_born: nil, alive?: true, bought?: false)
t5 = Tiger.create(name: "Christopher", price: 1000, breed: "Indonesian", health: 20, time_born: nil, alive?: true, bought?: false)
t6 = Tiger.create(name: "Kurt", price: 750, breed: "Indonesian", health: 20, time_born: nil, alive?: true, bought?: false)
t7 = Tiger.create(name: "Bon Scott", price: 100, breed: "Bengal", health: 20, time_born: nil, alive?: true, bought?: false)
